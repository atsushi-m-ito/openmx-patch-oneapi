/**********************************************************************
  ...
  Log of TRAN_DFT.c:
     ...
     24/Jul./2008  Modified by T. Ozaki
                ...
                double ChemP_e0[2]) 
{
  ...
  /*
  printf("ChemP=%15.12f %15.12f %15.12f\n",ChemP,ChemP_e[0],ChemP_e[1]);
  */
  ...
  *************************************************/
    ...
    *************************************************** */
    ...
    /***********************************************
                 calling Band_DFT_Col
    ***********************************************/

    TRAN_SCF_iter = iter; /* TRAN_SCF_iter is passed to Band_DFT_Col. */
  ...
  for (kloop0=0; kloop0<num_kloop0; kloop0++){
    ...
    if (parallel_mode){
      ...
      TRAN_DFT_Kdependent(MPI_CommWD1[myworld1],
			  ...
			  natn, ncn, M2G, G2ID, atv_ijk, List_YOUSO, SucceedReadingDMfile, 
                          CDM, EDM, Eele0, Eele1);
    }
    else{
